...
import com.crazecoder.openfile.shareintents.Generic;
import com.crazecoder.openfile.shareintents.Gmail;
import com.crazecoder.openfile.shareintents.Whatsapp;
...
// PluginRegistry.RequestPermissionsResultListener,
    ...
    private static final HashMap<String, Base> options = new HashMap<String, Base>();
    ...
    public static void registerWith(Registrar registrar) {
        ...
        options.put("generic", new Generic(registrar));
        options.put("gmail", new Gmail(registrar));
        options.put("whatsapp", new Whatsapp(registrar));
    ...
    //     if (requestCode == REQUEST_CODE && hasPermission(Manifest.permission.READ_EXTERNAL_STORAGE)
